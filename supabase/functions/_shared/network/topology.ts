// ⚠️ COPIA Deno de src/modules/network/topology.ts — Deno no importa de src/.
// Mantener en SINCRONÍA con el original (invariante en CLAUDE.md). Solo el edge
// ai-grade-submission usa esta copia para CALIFICAR (no necesita el intérprete).
/**
