...
const USE_CASES: UseCaseDef[] = [
  ...
  },
  {
    ...
    description:
      "System prompt que recibe el modelo cuando un estudiante conversa con el Tutor IA. Soporta placeholders {{course_name}}, {{course_description}}, {{course_content_topics}} (títulos de los contenidos generados) y {{course_content_material}} (extractos del TEXTO real de esos contenidos — guías/presentaciones/lecturas — para que el tutor responda anclado al contenido, no solo a los títulos).",
    defaultPrompt:
