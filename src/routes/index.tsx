    ...
    <div className="min-h-screen bg-background">
      ...
      <section className="max-w-7xl mx-auto px-6 py-20 md:py-28 text-center">
        ...
        <p className="mt-6 text-lg text-muted-foreground max-w-2xl mx-auto">
          Crea exámenes con preguntas generadas por IA, ejecuta código en vivo,
      ...
      <section className="max-w-7xl mx-auto px-6 pb-24 grid md:grid-cols-3 gap-4">
        {[
          ...
          { icon: Code, t: "Compilador integrado", d: "Editor Monaco con ejecución de Java, Python y JavaScript en tiempo real." },
          { icon: Clock, t: "Tiempo real", d: "Temporizador sincronizado con Supabase Realtime. Pausa y tiempo extra en vivo." },
          { icon: Wifi, t: "Modo offline", d: "PWA instalable con respuestas guardadas localmente y sincronización automática." },
        ].map(({ icon: Icon, t, d }) => (
          <div key={t} className="p-6 rounded-xl border bg-card hover:border-primary/30 transition-colors">
