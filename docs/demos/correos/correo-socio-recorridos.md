# Correo a socio — recorridos por rol (SuperAdmin · Admin · Docente · Estudiante)

> Correo listo para enviar a alguien con quien te quieras **asociar**. Incluye el
> recorrido en video de **los cuatro roles** + acceso de **Administrador** de prueba.
...
Te comparto ExamLab para que la conozcas a fondo y, si te suena, nos asociemos.
Es una plataforma educativa multi-institución con IA: exámenes con proctoring,
...
Así navegas todo el rol Admin (y con el cambiador de rol, también Docente y
