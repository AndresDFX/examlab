# Bienvenida a estudiantes — FESNA / La Nueva América

Versión del correo de bienvenida **específica para FESNA** (estudiantes de **La Nueva América**, correo `@lanuevaamerica.edu.co`). Incluye el **aviso de plataforma alterna** y **pantallazos reales** de lo que verá el estudiante. Base común: [`correo-bienvenida-estudiantes.md`](correo-bienvenida-estudiantes.md).

> Usuario de cada estudiante = su **correo institucional `@lanuevaamerica.edu.co`**. En el desplegable de la pantalla de inicio se elige **FESNA**. Contraseña temporal en el primer ingreso (se cambia).
