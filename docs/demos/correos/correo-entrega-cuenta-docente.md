# Entrega de cuenta de prueba — Docente

Mensaje para **entregarle a un docente su cuenta de demo** (con credenciales e instrucciones de ingreso). Hay una versión **correo** y una **WhatsApp**. Tono informal.

> Toma el **usuario** de la fila del docente en [`ExamLab-Usuarios-Demo.xlsx`](ExamLab-Usuarios-Demo.xlsx) (`docente1@demo-examlab.co` … `docente5@demo-examlab.co`). La **contraseña es la misma para todos** en el demo: `ExamlabDemo2026`.
...
- **Videos y presentación ya embebidos** (Supabase Storage / Google Slides) en correo y WhatsApp. Enlaces canónicos en [`_ENLACES-demos.md`](_ENLACES-demos.md). El **manual del docente** (PDF) va embebido como enlace.
