...
> ¡Hola [Nombre]!
>
> **Antes que nada:** ExamLab es una **plataforma alterna de apoyo** para nuestro curso (la administra tu docente). **No es la plataforma institucional oficial de la Universidad Antonio José Camacho** — úsala solo para las actividades de esta materia.
>
...
>
> Ojo: es una **plataforma alterna de apoyo** para nuestro curso, **no** es la plataforma oficial de la Universidad Antonio José Camacho; úsala solo para esta materia.
>
...
- **No quites el aviso de "plataforma alterna / no oficial"** — es intencional (la UNIAJC tiene su propia plataforma institucional; ExamLab es solo apoyo del curso).
