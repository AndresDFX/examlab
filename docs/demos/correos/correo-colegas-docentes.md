...
- **Modelo de IA (si preguntan por el costo):** la IA viene incluida; el docente/institución pone **su propia API key** (sin sobrecosto) o la usa como **add-on medido por consumo**, y la **cola de procesamiento** (modo inmediato o en cola) controla cuándo y cuánto corre la IA. Detalle en la presentación **Independientes** (`../presentacion/ExamLab-Presentacion-Independientes.pptx`).
